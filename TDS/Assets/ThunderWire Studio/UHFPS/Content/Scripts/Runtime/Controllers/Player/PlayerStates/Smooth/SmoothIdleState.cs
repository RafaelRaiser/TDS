...
namespace UHFPS.Runtime.States
{
    public class SmoothIdleState : SmoothStateAsset
    {
        ...
        public override string Name => "Smooth/Idle";

        public class IdlePlayerState : SmoothPlayerState
        {
            ...
            public override Transition[] OnGetTransitions()
            {
                return new Transition[]
                {
                    ...
                    {
                        bool runFlag = MovementInput.y < 0 || (MovementInput.y == 0 && MovementInput.x != 0);
                        bool runPressed = !runFlag && InputManager.ReadButton(Controls.SPRINT);
